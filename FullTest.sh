...
mpirun -n 16 ./broadcast data/oneD_source_1000 data/oneD_charge_1000
...
mpirun -n 16 ./broadcast data/oneD_source_10000 data/oneD_charge_10000
...
mpirun -n 16 ./broadcast data/oneD_source_100000 data/oneD_charge_100000
