...
#SBATCH -o data/result100k.out     	      #File to which standard out will be written
#SBATCH -e data/result100k.err      	      #File to which standard err will be written
...
#mpirun -np 256  ./symmetric 25600  -c 1 #-nocheck

#mpirun -np 256  ./symmetric 25600  -c 2 #-nocheck

#mpirun -np 256  ./symmetric 25600  -c 4 #-nocheck

#mpirun -np 256  ./symmetric 25600  -c 8 #-nocheck
