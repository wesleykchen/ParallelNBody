...
mpirun -np 256  ./symmetric 256000  -c 1 #-nocheck

mpirun -np 256  ./symmetric 256000  -c 2 #-nocheck

mpirun -np 256  ./symmetric 256000  -c 4 #-nocheck

mpirun -np 256  ./symmetric 256000  -c 8 #-nocheck
