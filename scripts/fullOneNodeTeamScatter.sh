...
#SBATCH -o newfullOneNodeTS256k.out     	      #File to which standard out will be written
#SBATCH -e newfullOneNodeTS256k.err      	      #File to which standard err will be written
