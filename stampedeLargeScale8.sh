...
#SBATCH -o data/a_stampede256kp8.out     	      #File to which standard out will be written
#SBATCH -e data/a_stampede256kp8.err      	      #File to which standard err will be written
