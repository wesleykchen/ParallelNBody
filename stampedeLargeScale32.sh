...
#SBATCH -o data/a_stampede256kp32.out     	      #File to which standard out will be written
#SBATCH -e data/a_stampede256kp32.err      	      #File to which standard err will be written
