...
#SBATCH -o newp128n256k.out     	      #File to which standard out will be written
#SBATCH -e newp128n256k.err      	      #File to which standard err will be written
...
mpirun -np 128  ./symmetric 256000  -c 1 #-nocheck

mpirun -np 128  ./symmetric 256000  -c 2 #-nocheck

mpirun -np 128  ./symmetric 256000  -c 4 #-nocheck

mpirun -np 128  ./symmetric 256000  -c 8 #-nocheck
