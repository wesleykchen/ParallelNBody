...
#SBATCH -o data/a_stampede256k_wait.out     	      #File to which standard out will be written
#SBATCH -e data/a_stampede256k_wait.err      	      #File to which standard err will be written
