...
mpirun -np 4096  ./symmetric 256000  -c 1 #-nocheck

mpirun -np 4096  ./symmetric 256000  -c 2 #-nocheck

mpirun -np 4096  ./symmetric 256000  -c 4 #-nocheck

mpirun -np 4096  ./symmetric 256000  -c 8 #-nocheck

mpirun -np 4096  ./symmetric 256000  -c 16 #-nocheck

mpirun -np 4096  ./symmetric 256000  -c 32 #-nocheck

mpirun -np 4096  ./symmetric 256000  -c 64 #-nocheck