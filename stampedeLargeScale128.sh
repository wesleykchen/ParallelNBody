...
#SBATCH -o data/a_stampede256kp128.out     	      #File to which standard out will be written
#SBATCH -e data/a_stampede256kp128.err      	      #File to which standard err will be written
